...
public interface GameServerServiceInterface extends ServiceInterface {
	 ...
	 * @param callerIp as a String only used for the logging of unauthorized access
	 ...
	 */
	public Response createGameServer(String callerIp, String authKey, JsonObject postInput);

	/**
	 * This method is called by the controller to build a list of all game
	 * server saved in the table {@code 'servers'} of the {@code 'gameserver'}
	 * database.
	 * @param callerIp as a String only used for the logging of unauthorized access
	 * @param authKey as a String to be compared with the one in the database to see
	 * if the caller is not unknown
	 ...
	 * @see {@link fr.fuwuyuan.gameserverapi.responses.ErrorResponse ErrorResponse}
	 */
	public Response getGameServers(String callerIp, String authKey);

	/**
	 * This method is called by the controller to fetch a game server by its
	 * {@code serverId} saved in the table {@code 'servers'} of the
	 ...
	 * @see {@link fr.fuwuyuan.gameserverapi.responses.ErrorResponse ErrorResponse}
	 */
	public Response getGameServerById(String callerIp, String authKey, String serverId);
	 ...
	 * the table {@code 'servers'} of the {@code 'gameserver'} database.
	 * @param callerIp as a String only used for the logging of unauthorized access
	 * @param authKey as a String to be compared with the one in the database to see
	 * if the caller is not unknown
	 ...
	 * @see {@link fr.fuwuyuan.gameserverapi.responses.ErrorResponse ErrorResponse}
	 */
	public Response getGameServerByGameNameAndGameVersion(String callerIp, String authKey,
	 ...
	 * {@code 'ports'} table of the {@code 'gameserver'} database and finally
	 * delete the record corresponding to that game server from the
	 * {@code 'servers'} table of the same database.
	 * @param callerIp as a String only used for the logging of unauthorized access
	 * @param authKey as a String to be compared with the one in the database to see
	 * if the caller is not unknown
	 * @param serverId as a String for the SQL request
	 ...
	 * @see {@link fr.fuwuyuan.gameserverapi.responses.ErrorResponse ErrorResponse}
	 */
	public Response shutdownGameServer(String callerIp, String authKey, String serverId);
}
