...
public interface PortServiceInterface extends ServiceInterface {
	...
	public enum PortError {
		SQL_ERROR_FETCH_LOG_AND_DO_NOTHING(-201),
		SQL_ERROR_UPDATE_LOG_AND_DO_NOTHING(-202),
		NO_PORT_CORRESPONDING_TO_GIVEN_IP(-210),
		NO_AVAILABLE_PORT_LEFT_ON_GIVEN_IP(-220);
